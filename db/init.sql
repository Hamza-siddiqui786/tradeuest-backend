-- ============================================================================
-- Gamified Trading Simulation â€” Complete DB Init (schema + migrations + seeds)
...
-- Monthly partitions â€” extend as needed
...
-- but was missing from the original schema â€” added here.
-- ---------------------------------------------------------------------------
CREATE TABLE IF NOT EXISTS user_missions (
  ...
  reward_granted boolean NOT NULL DEFAULT false,   -- â†� BUG FIX: was missing
  updated_at     timestamptz NOT NULL DEFAULT now(),
